                    ...
                    <div class="grid grid-cols-2 gap-x-6">
                        <div>
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input  onchange="changeImg()" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="img" type="file" name="image">
                                @error('image')
                                <p class="my-2 text-red-400">{{ $message  }}</p>
                                @enderror
