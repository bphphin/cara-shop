        ...
        <div class="activity">
            <div class="py-20">
                ...
                <form method="POST" action="{{ route('admin.category.update',$cate->id)  }}">
                    ...
                    <a href="{{ route('admin.category.index')  }}" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cancel</a>
                </form>
            </div>
        </div>
    </div>
